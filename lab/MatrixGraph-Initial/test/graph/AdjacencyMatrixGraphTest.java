...
/**
 * Unit tests class for AdjacencyMatrixGraph
 *
 * @author DEI_ESINF
 *
 */
public class AdjacencyMatrixGraphTest {
    ...
    public void testDirectConnections() {
        System.out.println("Test of Direct connection");
        ...
        Iterator<String> itEdge = instance.directConnections("Vert 2").iterator();
        ...
        itEdge = instance.directConnections("Vert 1").iterator();

        assertTrue("first connection should be \"Vert 2\"", (itEdge.next().compareTo("Vert 2") == 0));
        assertTrue("second connection should be \"Vert 3\"", (itEdge.next().compareTo("Vert 3") == 0));
        assertTrue("third connection should be \"Vert 5\"", (itEdge.next().compareTo("Vert 5") == 0));

        instance.removeEdge("Vert 1", "Vert 2");

        itEdge = instance.directConnections("Vert 1").iterator();
        assertTrue("first connection should now be \"Vert 3\"", (itEdge.next().compareTo("Vert 3") == 0));

        instance.removeEdge("Vert 1", "Vert 3");
        instance.removeEdge("Vert 1", "Vert 5");

        itEdge = instance.directConnections("Vert 1").iterator();
        assertTrue("connections should now be empty", (itEdge.hasNext() == false));
    }
